...
#define I2C1_SCL_OUT(x)                                                      \
    if (x)                                                                   \
    {                                                                        \
        HAL_GPIO_WritePin(FT6336_SCL_GPIOx, FT6336_SCL_PIN, GPIO_PIN_SET);   \
    }                                                                        \
    else                                                                     \
    {                                                                        \
        HAL_GPIO_WritePin(FT6336_SCL_GPIOx, FT6336_SCL_PIN, GPIO_PIN_RESET); \
    }

#define I2C1_SDA_OUT(x)                                                      \
    if (x)                                                                   \
    {                                                                        \
        HAL_GPIO_WritePin(FT6336_SDA_GPIOx, FT6336_SDA_PIN, GPIO_PIN_SET);   \
    }                                                                        \
    else                                                                     \
    {                                                                        \
        HAL_GPIO_WritePin(FT6336_SDA_GPIOx, FT6336_SDA_PIN, GPIO_PIN_RESET); \
    }
...
void Proc_Touch_inMainWin(struTouch, uint16_t *, FunctionalState *);
void Proc_Touch_inSubWin(struTouch, uint16_t *, FunctionalState *);
#endif
